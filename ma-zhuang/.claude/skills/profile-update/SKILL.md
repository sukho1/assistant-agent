...
计算距今天数：
- ≥7 天：触发**周更新**——每个维度/综合体写入 `{folder}/weekly/YYYY-WXX.md`（WXX 为 ISO 周数）
- ≥30 天：触发**月更新**——每个维度/综合体写入 `{folder}/monthly/YYYY-MM.md`
- ≥90 天：触发**季更新**——每个维度/综合体写入 `{folder}/quarterly/YYYY-QX.md`
